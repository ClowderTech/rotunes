...
export function setNestedKey(obj: Config, path: string, value: string | number | boolean): Config {
...
export function getNestedKey(obj: Config, key: string): string | number | boolean | Config | null {
